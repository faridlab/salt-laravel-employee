...
use SaltEmployee\Controllers\EmployeeTaxesController;
use SaltEmployee\Controllers\EmployeeWorkExperiencesController;
use SaltEmployee\Controllers\EmploymentsController;
...
Route::middleware(['api'])
    ...
    // API: EMPLOYMENTS
    Route::get("employments", [EmploymentsController::class, 'index'])->middleware(['auth:api']); // get entire collection
    Route::post("employments", [EmploymentsController::class, 'store'])->middleware(['auth:api']); // create new collection

    Route::get("employments/trash", [EmploymentsController::class, 'trash'])->middleware(['auth:api']); // trash of collection

    Route::post("employments/import", [EmploymentsController::class, 'import'])->middleware(['auth:api']); // import collection from external
    Route::post("employments/export", [EmploymentsController::class, 'export'])->middleware(['auth:api']); // export entire collection
    Route::get("employments/report", [EmploymentsController::class, 'report'])->middleware(['auth:api']); // report collection

    Route::get("employments/{id}/trashed", [EmploymentsController::class, 'trashed'])->where('id', '[a-zA-Z0-9-]+')->middleware(['auth:api']); // get collection by ID from trash

    // RESTORE data by ID (id), selected IDs (selected), and All data (all)
    Route::post("employments/{id}/restore", [EmploymentsController::class, 'restore'])->where('id', '[a-zA-Z0-9-]+')->middleware(['auth:api']); // restore collection by ID

    // DELETE data by ID (id), selected IDs (selected), and All data (all)
    Route::delete("employments/{id}/delete", [EmploymentsController::class, 'delete'])->where('id', '[a-zA-Z0-9-]+')->middleware(['auth:api']); // hard delete collection by ID

    Route::get("employments/{id}", [EmploymentsController::class, 'show'])->where('id', '[a-zA-Z0-9-]+')->middleware(['auth:api']); // get collection by ID
    Route::put("employments/{id}", [EmploymentsController::class, 'update'])->where('id', '[a-zA-Z0-9-]+')->middleware(['auth:api']); // update collection by ID
    Route::patch("employments/{id}", [EmploymentsController::class, 'patch'])->where('id', '[a-zA-Z0-9-]+')->middleware(['auth:api']); // patch collection by ID
    // DESTROY data by ID (id), selected IDs (selected), and All data (all)
    Route::delete("employments/{id}", [EmploymentsController::class, 'destroy'])->where('id', '[a-zA-Z0-9-]+')->middleware(['auth:api']); // soft delete a collection by ID
    ...
    // API: EMPLOYEE TAXES
    Route::get("employee_taxes", [EmployeeTaxesController::class, 'index'])->middleware(['auth:api']); // get entire collection
    Route::post("employee_taxes", [EmployeeTaxesController::class, 'store'])->middleware(['auth:api']); // create new collection

    Route::get("employee_taxes/trash", [EmployeeTaxesController::class, 'trash'])->middleware(['auth:api']); // trash of collection

    Route::post("employee_taxes/import", [EmployeeTaxesController::class, 'import'])->middleware(['auth:api']); // import collection from external
    Route::post("employee_taxes/export", [EmployeeTaxesController::class, 'export'])->middleware(['auth:api']); // export entire collection
    Route::get("employee_taxes/report", [EmployeeTaxesController::class, 'report'])->middleware(['auth:api']); // report collection

    Route::get("employee_taxes/{id}/trashed", [EmployeeTaxesController::class, 'trashed'])->where('id', '[a-zA-Z0-9-]+')->middleware(['auth:api']); // get collection by ID from trash

    // RESTORE data by ID (id), selected IDs (selected), and All data (all)
    Route::post("employee_taxes/{id}/restore", [EmployeeTaxesController::class, 'restore'])->where('id', '[a-zA-Z0-9-]+')->middleware(['auth:api']); // restore collection by ID

    // DELETE data by ID (id), selected IDs (selected), and All data (all)
    Route::delete("employee_taxes/{id}/delete", [EmployeeTaxesController::class, 'delete'])->where('id', '[a-zA-Z0-9-]+')->middleware(['auth:api']); // hard delete collection by ID

    Route::get("employee_taxes/{id}", [EmployeeTaxesController::class, 'show'])->where('id', '[a-zA-Z0-9-]+')->middleware(['auth:api']); // get collection by ID
    Route::put("employee_taxes/{id}", [EmployeeTaxesController::class, 'update'])->where('id', '[a-zA-Z0-9-]+')->middleware(['auth:api']); // update collection by ID
    Route::patch("employee_taxes/{id}", [EmployeeTaxesController::class, 'patch'])->where('id', '[a-zA-Z0-9-]+')->middleware(['auth:api']); // patch collection by ID
    // DESTROY data by ID (id), selected IDs (selected), and All data (all)
    Route::delete("employee_taxes/{id}", [EmployeeTaxesController::class, 'destroy'])->where('id', '[a-zA-Z0-9-]+')->middleware(['auth:api']); // soft delete a collection by ID
    ...
    Route::get("employee_work_experiences", [EmployeeWorkExperiencesController::class, 'index'])->middleware(['auth:api']); // get entire collection
    Route::post("employee_work_experiences", [EmployeeWorkExperiencesController::class, 'store'])->middleware(['auth:api']); // create new collection

    Route::get("employee_work_experiences/trash", [EmployeeWorkExperiencesController::class, 'trash'])->middleware(['auth:api']); // trash of collection

    Route::post("employee_work_experiences/import", [EmployeeWorkExperiencesController::class, 'import'])->middleware(['auth:api']); // import collection from external
    Route::post("employee_work_experiences/export", [EmployeeWorkExperiencesController::class, 'export'])->middleware(['auth:api']); // export entire collection
    Route::get("employee_work_experiences/report", [EmployeeWorkExperiencesController::class, 'report'])->middleware(['auth:api']); // report collection

    Route::get("employee_work_experiences/{id}/trashed", [EmployeeWorkExperiencesController::class, 'trashed'])->where('id', '[a-zA-Z0-9-]+')->middleware(['auth:api']); // get collection by ID from trash

    // RESTORE data by ID (id), selected IDs (selected), and All data (all)
    Route::post("employee_work_experiences/{id}/restore", [EmployeeWorkExperiencesController::class, 'restore'])->where('id', '[a-zA-Z0-9-]+')->middleware(['auth:api']); // restore collection by ID

    // DELETE data by ID (id), selected IDs (selected), and All data (all)
    Route::delete("employee_work_experiences/{id}/delete", [EmployeeWorkExperiencesController::class, 'delete'])->where('id', '[a-zA-Z0-9-]+')->middleware(['auth:api']); // hard delete collection by ID

    Route::get("employee_work_experiences/{id}", [EmployeeWorkExperiencesController::class, 'show'])->where('id', '[a-zA-Z0-9-]+')->middleware(['auth:api']); // get collection by ID
    Route::put("employee_work_experiences/{id}", [EmployeeWorkExperiencesController::class, 'update'])->where('id', '[a-zA-Z0-9-]+')->middleware(['auth:api']); // update collection by ID
    Route::patch("employee_work_experiences/{id}", [EmployeeWorkExperiencesController::class, 'patch'])->where('id', '[a-zA-Z0-9-]+')->middleware(['auth:api']); // patch collection by ID
    // DESTROY data by ID (id), selected IDs (selected), and All data (all)
    Route::delete("employee_work_experiences/{id}", [EmployeeWorkExperiencesController::class, 'destroy'])->where('id', '[a-zA-Z0-9-]+')->middleware(['auth:api']); // soft delete a collection by ID
